...
class ProductionConfigurationValidatorTests {
    ...
    private MockEnvironment validEnvironment() {
        return new MockEnvironment()
                ...
                .withProperty("agentmind.web.trusted-proxy.enabled", "true")
                .withProperty("agentmind.web.trusted-proxy.require-https", "true")
                .withProperty("agentmind.web.trusted-proxy.cidrs", "10.0.0.0/8")
